        ...
        implements IRandom
{
    ...
    public void init(byte[] keyMaterial)
    {
        this.setup(keyMaterial);
    ...
    {
        throw new IllegalStateException("random state is non-modifiable");
    }
    ...
    public abstract void setup(byte[] keyMaterial);
